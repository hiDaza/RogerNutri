...
export default function InformacoesUsuarioPasso4({ navigation, route }) {
  ...
  const { peso, altura, movimentacao, genero, dataNascimento } = dadosCadastro || {};
  ...
  const navegarParaPasso5 = () => {
    const dadosParaPasso5 = {
        ...dadosCadastro,
        imc: parseFloat(imc),
        categoria,
        pesoIdealMin,
    ...
    console.log("Passo4 enviando para Passo5:", dadosParaPasso5);
  
    navigation.navigate("InformacoesUsuarioPasso5", {
      dadosCadastro: dadosParaPasso5
    });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Passo 4/5</Text>
